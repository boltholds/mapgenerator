#It's lite version of original file xls2xlsx.py from xls2xlsx module library
#I removed the url,html and x2h support module because it imported a bunch of different modules 
#that took up too much space and are not suitable for my tasks
...
class XLS2XLSX:
    ...
    def __init__(self, f, dirname='.'):
        """f is filename, file object, or xls file contents as a bytes object"""
